...
model_ckpt_dir  = \
    "C:/Users/admin/Desktop/TF_Models/twitter_transformer.ckpt"
train_loss_file = \
    "C:/Users/admin/Desktop/Codes/train_loss_transformer.csv"

# Load the data. #
tmp_pkl_file = "C:/Users/admin/Desktop/Codes/twitter_corpus.pkl"
...
seq2seq_model = tf_transformer.TransformerNetwork(
    ...
    enc_vocab_size, dec_vocab_size, seq_encode, 
    seq_decode, embed_size=hidden_size, p_keep=prob_keep)
