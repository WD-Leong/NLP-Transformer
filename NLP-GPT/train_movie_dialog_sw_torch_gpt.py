...
import torch
import torch_gpt as gpt_module
...
model_ckpt_dir  = "PyTorch_Models/dialog_sw_torch_gpt_module"
train_loss_file = "train_loss_dialog_sw_torch_gpt_module.csv"
...
gpt_model = gpt_module.GPTDecoder(
    num_layers, num_heads, 
    hidden_size, ffwd_size, vocab_size, 
    seq_length, rate1=0.0, rate2=prob_drop)
if torch.cuda.is_available():
    gpt_model.to("cuda")
...
while n_iter < maximum_iter:
    ...
    tmp_loss = sub_batch_train_step(
        ...
        gpt_optimizer, seg_length=seq_length)
